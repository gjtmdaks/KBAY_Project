...
<body>
	...
	<section class="container auction-list">
		<h3 class="section-title">시작 예정인 경매</h3>
		<form method="get" action="">
		    <div style="display:flex; gap:20px; margin-bottom:20px;">
		        ...
		        <select name="sort">
		            ...
		            <option value="startAsc" ${sort == 'startAsc' ? 'selected' : ''}>시작 임박순</option>
		            <option value="startDesc" ${sort == 'startDesc' ? 'selected' : ''}>시작 여유순</option>
		...
		<div class="item-grid">
			<c:forEach var="it" items="${itemList}">
			    ...
			    <jsp:include page="itemCard.jsp">
			        <jsp:param name="type" value="yetDeal"/>
			    </jsp:include>
			</c:forEach>
		</div>
	</section>
